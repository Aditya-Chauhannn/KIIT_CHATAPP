...
import com.example.kiit_chatapp.activities.ImageViewerActivity;
...
public class MessageAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof SentMessageViewHolder) {
            ...
            sentHolder.sentImageView.setVisibility(View.GONE);
            ...
            if ("text".equals(msg.getType())) {
                ...
                sentHolder.sentImageView.setVisibility(View.VISIBLE);
                Glide.with(context).load(msg.getFileUrl()).into(sentHolder.sentImageView);
                sentHolder.sentImageView.setOnClickListener(v -> {
            ...
            recvHolder.receivedImageView.setVisibility(View.GONE);
            ...
            if ("text".equals(msg.getType())) {
                ...
                recvHolder.receivedImageView.setVisibility(View.VISIBLE);
                Glide.with(context).load(msg.getFileUrl()).into(recvHolder.receivedImageView);
                recvHolder.receivedImageView.setOnClickListener(v -> {
                    Intent intent = new Intent(context, ImageViewerActivity.class);
                    intent.putExtra("imageUrl", msg.getFileUrl());
                    context.startActivity(intent);
                });
